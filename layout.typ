...
#let keywords = ("Hijri", "ISO 8601", "Calendars", "Week date", "Reproducible research")
#let abstractContent = "This document defines the Hijri week calendar (HWC) which is a counterpart of the ISO 8601 calendar but for Hijri calendars. dates generated by this calendar are referred to as Hijri week dates (HWD). Since Hijri calendars are lunar calendars, it was necessary to define a standard counterpart to the ISO 8601 calendar for them tailored to the unique aspects of Hijri calendars while aligning with the fundamental principles of the ISO 8601 calendar."
